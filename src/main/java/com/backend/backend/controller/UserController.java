...
import com.backen.backend.DTO.MessageResponse;
...
public class UserController {
	...
	public ResponseEntity<JwtResponse> authenticateUser(@Validated @RequestBody LoginRequest loginRequest) {
		...
		return ResponseEntity.ok(
				new JwtResponse(JWT, userDetails.getId(), userDetails.getEmail(), userDetails.getPassword(), roles));
...
//			return null;
	...
	@PostMapping("/signup")
	public ResponseEntity<?> registerUser(@Valid @RequestBody com.backen.backend.DTO.SignUpRequest signUpRequest) {
